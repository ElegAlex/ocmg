...
use AppBundle\Entity\Praticien;
use AppBundle\Entity\Theme;
use AppBundle\Entity\Utaa;
use AppBundle\Entity\Ville;
use AppBundle\Repository\CiblageRepository;
use AppBundle\Form\UploadFileType;
use AppBundle\Tableaux\ListeCiblageUpload;
use AppBundle\Tableaux\ListePraticiensUpload;
use AppBundle\Tableaux\ListeUpload;
...
class ImportController extends AbstractController
{
    ...
    public function uploadpraticienAction(Request $request)
    {
        ...
        $filename = $this->getRepository('AppBundle:FichierUpload')->findAll();
        ...
        return $this->render(
            ...
            'AppBundle:Admin/Import:fichier.html.twig',
...
//               modification du php.ini pour upload de large file
    ...
    public function listeAction()
    {
        ...
        return $this->render(
            ...
            'AppBundle:Admin/Import/Liste:liste.html.twig',
    ...
    public function detailAction(Request $request, $id): Response
    {
        ...
        $fichiersUpload =
            $this->getRepository('AppBundle:FichierUpload')
                ->findOneById($id);

        //si le fichierupload est praticien
        if ($fichiersUpload->getFilename() === 'praticien') {
            $theme =
                $this->getRepository('AppBundle:Theme')
                    ->findAll();
            ...
            return $this->render(
                'AppBundle:Admin/Import/Liste:detail.html.twig',
                ['fichiersUpload' => $fichiersUpload,
                    'theme' => $theme,
            ...
            $colonneTheme = array_keys($this->getRepository('AppBundle:Data')->liste()[0]);
            ...
            if ($filenameUpload[0] === 'commentaire') {
                ...
                $tableau->getDataHandler()->setRepository($this->getRepository('AppBundle:Theme'));

            } else {


                $tableau->getDataHandler()->setRepository($this->getRepository('AppBundle:Data'));
